...
let someObj: someObjType = {
    name: 'Eugene',
    age: 32,
    greeting: function e() { return console.log(`My name is ${this.name}. I am ${this.age}`) }
}
...
let counter: COunterType = {
    count: 0,
    getCurrentCount: function q() { console.log(this.count) },
    increment: function w() { this.count++ },
    decrement: function e() { this.count-- },
    setCurrentCount: function r(n: number) { this.count = n },
    restCurrentCount: function t() { this.count = 0 }
}
